...
/**
 * @extends ServiceEntityRepository<Journaliste>
 *
...
class JournalisteRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(Journaliste $entity, bool $flush = false): void
    {
    ...
    public function remove(Journaliste $entity, bool $flush = false): void
    {
